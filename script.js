...
async function shareInvitationWithImage() {
    // ✅ photo19.jpeg file එක
    const imageFile = "photo19.jpeg";
    ...
    // ✅ Mobile Share API - photo19 උඩින්, message පහළින්
    if (navigator.share) {
        try {
            // photo19.jpeg file එක fetch කරනවා
    ...
    // ✅ Fallback: Desktop - message එක විතරක්
